 ...
 * - Jika pengguna berada pada proses pembaruan data maka setiap field pada form sudah terisi otomatis
 ...
 * Jika pengguna menekan tombol back baik pada ActionBar maupun peranti, maka akan tampil dialog konfirmasi sebelum menutup halaman.
...
public class FormAddUpdateActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        if (view.getId() == R.id.btn_submit){
            ...
            if (!isEmpty){
                ...
                if (isEdit){
                    ...
                    //Setiap aksi akan mengirimkan data dan RESULT_CODE untuk diproses pada MainActivit
     ...
     * setiap field pada form sudah terisi otomatis.
     * Ikon untuk hapus di sudut kanan atas ActionBar berfungsi
     * untuk menghapus data. Kode berikut akan menjalankan kebutuhan di atas.

     * Intinya cek nilai boolean isEdit yang berasal dari proses validasi,
     * apakah obyek note berisi null atau tidak.
     * @param menu
     * @return
     */
    @Override
    ...
    private void showAlertDialog(int type){
         ...
         * Dialog konfirmasi tersebut muncul sebelum menutup halaman.
         * Untuk itu, gunakan fasilitas AlertDialog untuk menampilkan dialog.
         */
